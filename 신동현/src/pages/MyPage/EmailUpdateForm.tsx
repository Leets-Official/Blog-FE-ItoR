...
const EmailUpdateForm = () => {
  ...
  return (
    <InputContainer>
      <Input title="메일" type="text" placeholder="이메일" control={control} name="email" disabled={!isModify}/>
      ...
      <Input title="이름" type="text" placeholder="이름" control={control} name="name" disabled={!isModify}/>
      <Input title="생년월일" type="text" placeholder="YYYY-MM-DD"control={control} name="birth" disabled={!isModify}/>
    </InputContainer>
  )
}
