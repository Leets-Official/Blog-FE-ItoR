...
const WriteForm = () => {
  const formControl = useContext(FormControlContext) as { control: Control<z.infer<typeof writeSchema>> };
  return (
    <Wrapper>
      <Hr />
      ...
      <Container>
        <TitleInputContainer>
          <Input type="text" placeholder="제목" style={{ fontSize: "24px", fontWeight: "500" }} noneBorder={true} name="title" control={formControl.control} value={""} />
        </TitleInputContainer>
        <Hr />
      </Container>
      <Controller
