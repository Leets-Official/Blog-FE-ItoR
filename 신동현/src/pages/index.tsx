...
import KaKaoForm from "./SignUp/KakaoForm";
...
export { Home, SignUp, SignUpDetail, EmailForm, KaKaoForm, Mypage, KakaoLoginLoading, Detail, Write, WriteForm, Update, UpdateForm, Root, NotFound };
